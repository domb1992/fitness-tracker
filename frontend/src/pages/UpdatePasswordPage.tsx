  ...
  return (
    <div className="ft-screen" style={{ paddingBottom: 32 }}>
      ...
      <div style={{ padding: '8px 20px 14px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        ...
        <div className="mono-tag">Update Password</div>
        <div style={{ width: 32 }} />
      </div>
      ...
      <div style={{ padding: '0 20px', display: 'flex', flexDirection: 'column', gap: 16 }}>
        {done ? (
          <div className="surface" style={{ padding: '24px 20px', textAlign: 'center' }}>
            ...
            <h2 style={{ margin: '0 0 8px', fontSize: 18, fontWeight: 700, letterSpacing: '-0.02em' }}>Password updated</h2>
            <p style={{ margin: '0 0 24px', fontSize: 14, color: 'var(--ink-2)' }}>You're all set. Your new password is active.</p>
          ...
          <div className="surface" style={{ padding: '18px 16px' }}>
            <div className="mono-tag" style={{ marginBottom: 14 }}>Set New Password</div>
